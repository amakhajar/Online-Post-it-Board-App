...
<div className="divide-y divide-gray-200">
          ...
          <div className="modal-action flex justify-end">
            <form method="dialog">
              <button type="submit" className="text-slate-100 bg-slate-300 hover:bg-slate-500  focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 lg:mr-5 sm:mr-3 " >Cancel</button>
